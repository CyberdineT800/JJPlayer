...
public class FolderHierarchyAdapter extends RecyclerView.Adapter<FolderHierarchyAdapter.ViewHolder> {
    ...
    private Stack<File> folderStack;
    private OnItemClickListener listener;

    public FolderHierarchyAdapter(Context context, Stack<File> folderStack) {
    ...
    public void setFolderStack(List<File> folderStack) {
        this.folderStack = (Stack<File>) folderStack;
    }
}
